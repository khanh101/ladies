...
def sampler(batch_nodes: np.ndarray, samp_num_list: np.ndarray, num_nodes: int, p_matrix: sparse.csr_matrix,
            lap2_matrix: sparse.csr_matrix, num_layers: int) -> SimpleNamespace:
    # INPUT
...
def full_sampler(batch_nodes: np.ndarray, samp_num_list: np.ndarray, num_nodes: int, p_matrix: sparse.csr_matrix,
                 lap2_matrix: sparse.csr_matrix, num_layers: int) -> SimpleNamespace:
...
def ladies_sampler(batch_nodes: np.ndarray, samp_num_list: np.ndarray, num_nodes: int, p_matrix: sparse.csr_matrix,
                   lap2_matrix: sparse.csr_matrix, num_layers: int) -> SimpleNamespace:
    """
